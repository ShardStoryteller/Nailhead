...
public enum BattleEnemy {
    ...
    SCARJIA("Scarjia", "Female", 900, 20, 20, 12, 16, 10),
    ...
    TWILIGHT("Twilight", "Female", 900, 20, 20, 16, 16, 16),
    ...
    JANE("Jane Shard", "Female", 600, 20, 10, 10, 10, 20),
    NYX("Nyx", "Nonbinary", 850, 20, 20, 8, 16, 16),
    DARK_MECCHRIS_V2("Alloy M", "Inanimate", 1200, 20, 20, 20, 4, 16),
    DARK_CHRIS_2("Dark Chris", "Male", 700, 20, 20, 16, 16, 16),
